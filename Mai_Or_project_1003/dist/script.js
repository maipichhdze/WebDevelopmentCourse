...
function sendEmail(){
  ...
  var userText = document.forms["myForm"]["message"].value;

  if (userName == "") {
    $("#feedback").css('color','red');
    $("#feedback").text("יש למלא שדה שם"); 
    return false;
  }
 else if (userEmail=="") {
  $("#feedback").css('color','red');
    $("#feedback").text("יש למלא שדה כתובת דואר אלקטרוני"); 
    return false;
  }
else  if (userText == "") {
  $("#feedback").css('color','red');
    $("#feedback").text("יש למלא שדה תוכן ההודעה"); 
    return false;
  }
  else{
    $("#feedback").css('color','green');
    $("#feedback").text("ההודעה נשלחה בהצלחה!"); 
    return flase;
