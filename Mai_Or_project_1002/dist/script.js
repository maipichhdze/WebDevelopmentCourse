...
$(document).ready(function () {
    ...
    $("#myNav").hide();
      ...
      // $("#collapsed").toggle(function(){
      //   $(".panel-heading").css('background-color','-webkit-linear-gradient(to left, #5B86E5, #36D1DC)');
      //   $(".panel-heading").css('background-color','linear-gradient(to left, #5B86E5, #36D1DC)');
      //   $(".collapsed").css('font-weight','bold');
